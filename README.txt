...
Tags: media library, bulk action, toggle category, taxonomy, taxonomies, attachment, media category, media categories, media tag, media tags, media taxonomy, media taxonomies, media filter, media organizer, media types, media uploader, custom, media management, attachment management, files management, user experience, wp-admin, admin
...
A plugin to provide category management functionality for media in WordPress sites.

== Description ==
This WordPress plugin will ease the management of media categories.
...
* toggle any media taxonomy assignment from Media Library via admin,
...
7. The admin page showing the shortcode explanations for this plugin.
8. The post edit page showing an example using the [wp-mcm category="mediafoto,medialogo"] shortcode.
9. The post page showing the results of the example using the [wp-mcm category="mediafoto,medialogo"] shortcode.
